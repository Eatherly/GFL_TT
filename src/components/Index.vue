    ...
    <div class="container">
      ...
      <b-container class="bv-example-row">
        ...
        <b-row v-for="(budy, i) in budies" :key="budy.email" class="text-center items-of-list">
          ...
          <b-col @click="clickEdit(budy)" class="edit" cols="1">
            <b-icon icon="pencil-fill"></b-icon>
          </b-col>
          <b-col @click="clickDelete(budy)" class="delete" cols="1">
      ...
      <b-row class="text-right add-budy-bar">
        <b-col cols="12">
          ...
          <userForm :budyForEdit="budyForEdit" :budies="budies" :editCase="editCase" @reset-edit-mode="resetEditMode"
                    @add-edit-budy="addEditBudy"></userForm>
        </b-col>
      </b-row>
    </div>
  </section>
